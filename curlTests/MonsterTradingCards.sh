...
curl -i -X GET http://localhost:10001/cards --header "Authorization: Bearer $token"
...
curl -i -X GET http://localhost:10001/deck --header "Authorization: Bearer $token" 
...
#echo "Should return HTTP 2xx"
#echo .
#curl -i -X GET http://localhost:10001/deck --header "Authorizatin: Bearer altenhof-mtcgToken"
#echo "Should return HTTP 200 - and a list of all cards"
#echo .
#echo .
#
